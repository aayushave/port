...
alert("ATTENTION !\nThis software requires an MOUSE to work!\nSorry if inconvenience caused");
...
function LogicSim() {
	...
	this.initialize = function () {
        ...
        document.getElementById("canvas").style.overflow = "scroll";
		this.toolbar = new Toolbar();
		var grp1 = this.toolbar.addGroup("OPEN SIMULATOR");
		var grp2 = this.toolbar.addGroup("OPEN SIMULATOR");
		var grp3 = this.toolbar.addGroup("OPEN SIMULATOR");
		var grp4 = this.toolbar.addGroup("OPEN SIMULATOR");
		...
		grp.addItem(new Button.Tool(images.newic, function () {
			...
			// prompt({
			// 	title: 'Error',
			// 	label: 'Please enter a name for the new integrated circuit.',
			// 	value: '',
			// 	inputAttrs: {
			// 		type: 'text'
			// 	}
		...
		grp = this.toolbar.addGroup("Input Sources");
