...
function ConstInput()
{
	...
	this.icon = images.const_icon;
	
	this.__proto__ = new DefaultGate("IN", this.icon, true, [],
		[
			new SocketInfo(SocketFace.right, 2, "Q")
		]
...
function TFlipFlop()
{
	this.__proto__ = new DefaultGate("TFLIPFLOP", images.tflipflop, false,
		[
			new SocketInfo(SocketFace.left,  2, "T"),
			new SocketInfo(SocketFace.left,  6, ">")
		],
		[
			new SocketInfo(SocketFace.right,  2, "Q"),
