                                              ...
                                              <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('images/hero_1.jpg')">
                                                <div class="container">
                                                  <div class="row align-items-center justify-content-center text-center">
                                                    <div class="col-md-7">
                                                      <span class="d-block mb-3 text-white" data-aos="fade-up">Images<span class="mx-2 text-primary">&bullet;</span> by Studio</span>
                                                        <h1 class="mb-4" data-aos="fade-up" data-aos-delay="100"> <?php echo $img ?></h1>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div id="posts" class="row no-gutter">
		  ...
		  $sql = "SELECT * FROM gallery where imgFullNameGallery LIKE '$immg%'";
        ...
        <div class="row text-center">
          <div class="col-md-12">
			<ul class="social-icon">
								...
								<li><a href="#" class="icon-mobile" ></a></li>
