        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-7">
              ...
              <p>We at Studio believe in creating memories, We are the best professionals you could find&nbsp;<i class="icon-smile-o text-white" aria-hidden="true"></i></p>
              <p><a href="#contact" class="btn btn-primary smoothScroll">Contact Me</a></p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="bg-white p-3 p-md-5">
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block mb-3">
                  ...
                  <span>Sample Address</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Phone:</span><span>+91 0000000000</span></li>
				<li class="d-block mb-3"><span class="d-block text-black">Phone:</span><span>+91 0000000000</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Email:</span><span> Sample Email </span></li>
                
                
             <!--   <span>Shop No 1, Shirbhate Complex, Moti Nagar Main Road,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dastur Nagar, Amravati 444605</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Phone:</span><span>+91 8888421870</span></li>
				<li class="d-block mb-3"><span class="d-block text-black">Phone:</span><span>+91 7030783273</span></li>
