            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active"><a href="photography.php" class="nav-link">Photography</a></li>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-7">
              ...
              <p>“Photography is a way of feeling, of touching, of loving. What you have caught on film is captured forever… It remembers little things, long after you have forgotten everything.” Anupam studio</p>
   ...
   <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="gallery.php?processing=PRE-WEDDING">
                <img src="images/PRE-WEDDING.png" alt="- PRE WEDDING - by Anupam Studio" title=""
                 class="img-fluid">
              <div class="post-entry-1-contents">
                <h6 style=" text-align: center; color: #2a2a2a;font-size: 16px;">Create memories of your journey</h6>
               </div>
              </a>
               <hr>
            </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="gallery.php?processing=WEDDING">
                <img src="images/WEDDING-BELLS.png" alt="- WEDDING - by Anupam Studio" title=""
                 class="img-fluid">
              <div class="post-entry-1-contents">
                <h6 style=" text-align: center; color: #2a2a2a;font-size: 16px;">Create memories of your journey</h6>
               </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="gallery.php?processing=BUMP-CLICKS">
                <img src="images/BUMP-CLICKS.png" alt="- BUMP CLICKS - by Anupam Studio" title=""
                 class="img-fluid">
              <div class="post-entry-1-contents">
                <h6 style=" text-align: center; color: #2a2a2a;font-size: 16px;">Create memories of your journey</h6>
               </div>
        ...
        <div class="row">
           <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="gallery.php?processing=TALKIES">
                <img src="images/TALKIES.png" alt="- TALKIES - by Anupam Studio" title=""
                 class="img-fluid">
              <div class="post-entry-1-contents">
                <h6 style=" text-align: center; color: #2a2a2a;font-size: 16px;">Create memories of your journey</h6>
               </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="gallery.php?processing=FOLIO">
                <img src="images/PORTFOLIO.png" alt="- FOLIO - by Anupam Studio" title=""
                 class="img-fluid">
              <div class="post-entry-1-contents">
                <h6 style=" text-align: center; color: #2a2a2a;font-size: 16px;">Create memories of your journey</h6>
               </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="gallery.php?processing=LITTLE-ONES">
                <img src="images/LITTLE-ONES.png" alt="- LITTLE-ONES - by Anupam Studio" title=""
                 class="img-fluid">
              <div class="post-entry-1-contents">
                <h6 style=" text-align: center; color: #2a2a2a;font-size: 16px;">Create memories of your journey</h6>
               </div>
